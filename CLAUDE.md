...
- TypeScript 5.3+ (strict mode enabled) + React 19, Next.js 16 (App Router), Tailwind CSS 4.0, pnpm 10+ (005-fix-night-mode)
- N/A (no data persistence involved in this feature) (005-fix-night-mode)
...
## Recent Changes
- 005-fix-night-mode: Added TypeScript 5.3+ (strict mode enabled) + React 19, Next.js 16 (App Router), Tailwind CSS 4.0, pnpm 10+
