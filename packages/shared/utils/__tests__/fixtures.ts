...
export const MOCK_HYMNS = [
  {
    ...
    subcategory: { number: 1, name: 'Sub 1' },
    fullText: 'Było światłem twoje słowo Ks. Stanisław Kiedy noc nas otaczała Jeżeli serce twoje boli Święty',
  },
  {
    number: 42,
    ...
    category: 'I. NABOŻEŃSTWO',
    subcategory: { number: 1, name: 'Sub 1' },
    fullText: 'Jeżeli zapytasz mnie o żal Maria Konopnicka O drzewo stare Pieśń moja Życzę tobie',
  },
  {
    number: 7,
    ...
    category: 'I. NABOŻEŃSTWO',
    subcategory: { number: 1, name: 'Sub 1' },
    fullText: 'Na początku było słowo Kraków Która niego dla mnie Powie serce moje Aleluia',
  },
]
